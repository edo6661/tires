        ...
        <div class="grid md:grid-cols-[250px_1fr] gap-10">
            <aside class="sm:sticky top-8 self-start text-main-text md:border-r md:border-disabled/50 md:pr-6 space-y-8">
                ...
                <div>
                    ...
                    <ul class="space-y-1 leading-tight text-body-md">
                        ...
                        @else
                            ...
                            <li><span class="font-medium w-8 inline-block">{{ __('home.days.monday') }}</span> 10:00 - 18:00</li>
                            <li><span class="font-medium w-8 inline-block">{{ __('home.days.tuesday') }}</span> 10:00 - 18:00</li>
                            <li><span class="font-medium w-8 inline-block">{{ __('home.days.wednesday') }}</span> {{ __('home.closed') }}</li>
                            <li><span class="font-medium w-8 inline-block">{{ __('home.days.thursday') }}</span> {{ __('home.closed') }}</li>
                            <li><span class="font-medium w-8 inline-block">{{ __('home.days.friday') }}</span> 10:00 - 18:00</li>
                            <li><span class="font-medium w-8 inline-block">{{ __('home.days.saturday') }}</span> 10:00 - 18:00</li>
                            <li><span class="font-medium w-8 inline-block">{{ __('home.days.sunday') }}</span> 10:00 - 18:00</li>
                        @endif
                    </ul>
                </div>
                ...
                <nav class="pt-6 border-t border-disabled/50 space-y-2">
                    <a href="#" class="block text-link hover:text-link-hover text-body-md transition-colors duration-200">{{ __('home.about_us') }}</a>
                    <a href="#" class="block text-link hover:text-link-hover text-body-md transition-colors duration-200">{{ __('home.contact_us') }}</a>
                    <a href="#" class="block text-link hover:text-link-hover text-body-md transition-colors duration-200">{{ __('home.terms_of_service') }}</a>
                </nav>
            </aside>
            <section aria-label="{{ __('home.services_list_aria') }}" class="space-y-6">
                    ...
                    <article
                        ...
                        <div class="flex items-start justify-between gap-4 w-full">
                            <div class="space-y-2">
                                ...
                                <p class="text-body-md text-main-text/80">{{ $menu->required_time }} {{ __('home.duration_unit') }}</p>
                                @if ($menu->description)
                            ...
                            <div class="flex flex-col justify-between items-end shrink-0 gap-4 min-h-[80px]">
                                <button aria-label="{{ __('home.view_details') }}" class="text-secondary-button hover:text-link transition-colors" title="{{ __('home.view_details') }}">
                ...
                @empty
                    <article
                        ...
                        <div class="flex items-start justify-between gap-4 w-full">
                            <div class="space-y-2">
                                <h2 class="text-heading-lg font-semibold text-brand">{{ __('home.empty_service_name') }}</h2>
                                <p class="text-body-md text-main-text/80">{{ __('home.empty_service_duration') }} {{ __('home.duration_unit') }}</p>
                            </div>
                            <div class="flex flex-col justify-between items-end shrink-0 gap-4 min-h-[80px]">
                                <button aria-label="{{ __('home.view_details') }}" class="text-secondary-button hover:text-link transition-colors" title="{{ __('home.view_details') }}">
                                    <i class="fa-solid fa-circle-info fa-lg" aria-hidden="true"></i>
                                </button>
                                <a href="#" class="block rounded-full bg-main-button hover:bg-btn-main-hover text-footer-text text-button-md font-semibold px-6 py-2 transition-colors duration-300" type="button">{{ __('home.book_button') }}</a>
                            </div>
                        </div>
                    </article>
                @endforelse
