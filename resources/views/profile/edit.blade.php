<x-layouts.app>
    <div class="container">
        <h1 class="text-title-lg font-semibold text-main-text mb-6">{{ __('profile/edit.title') }}</h1>
        <form action="{{ route('profile.update') }}" method="POST" class="bg-white p-8 rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 ease-in-out space-y-6">
            ...
            <div class="transform transition-all duration-200">
                <label for="full_name" class="block text-body-md font-medium text-main-text">{{ __('profile/edit.form.full_name.label') }}</label>
            ...
            <div class="transform transition-all duration-200">
                <label for="full_name_kana" class="block text-body-md font-medium text-main-text">{{ __('profile/edit.form.full_name_kana.label') }}</label>
            ...
            <div class="transform transition-all duration-200">
                <label for="email" class="block text-body-md font-medium text-main-text">{{ __('profile/edit.form.email.label') }}</label>
            ...
            <div class="transform transition-all duration-200">
                <label for="phone_number" class="block text-body-md font-medium text-main-text">{{ __('profile/edit.form.phone_number.label') }}</label>
            ...
            <div class="transform transition-all duration-200">
                <label for="date_of_birth" class="block text-body-md font-medium text-main-text">{{ __('profile/edit.form.date_of_birth.label') }}</label>
            ...
            <div class="transform transition-all duration-200">
                <label for="home_address" class="block text-body-md font-medium text-main-text">{{ __('profile/edit.form.home_address.label') }}</label>
            ...
            <div class="flex items-center justify-end space-x-4 pt-4 border-t border-disabled/50">
                <a href="{{ route('profile.show') }}" class="bg-secondary-button hover:bg-disabled text-main-text font-bold py-2 px-4 rounded-lg transition-all duration-300  hover:-translate-y-0.5 text-button-md">
                    {{ __('profile/edit.form.buttons.cancel') }}
                </a>
                <button type="submit" class="bg-main-button hover:bg-btn-main-hover text-white font-bold py-2 px-4 rounded-lg transition-all duration-300  hover:-translate-y-0.5 text-button-md">
                    {{ __('profile/edit.form.buttons.save') }}
                </button>
            </div>
        </form>
    </div>
