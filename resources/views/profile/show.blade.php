    ...
    <div class="container space-y-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            <div class="border-b border-gray-200 pb-4 mb-4 flex justify-between items-center">
                <h2 class="text-xl font-medium text-gray-700">Personal Information</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <dt class="text-sm font-medium text-gray-500">Full Name (Kana)</dt>
        ...
        <div class="bg-white p-6 rounded-lg shadow">
             <div class="border-b border-gray-200 pb-4 mb-4">
                <h2 class="text-xl font-medium text-gray-700">Change Password</h2>
            </div>
