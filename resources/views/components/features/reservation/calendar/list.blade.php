                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                ...
                                @if($reservation->status->value === 'pending')
                                    <button onclick="updateStatus({{ $reservation->id }}, 'confirmed')"
                                ...
                                @if(in_array($reservation->status->value, ['pending', 'confirmed']))
                                    <button onclick="updateStatus({{ $reservation->id }}, 'cancelled')"
...
function toggleAdvancedFilters() {
    // Implementation for advanced filters toggle
...
function updateStatus(reservationId, status) {
    ...
    fetch(`/admin/reservation/${reservationId}/${endpoint}`, {
        method: 'POST',
        headers: {
