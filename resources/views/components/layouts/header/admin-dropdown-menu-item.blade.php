...
<a href="{{ $href }}" 
   class="flex items-center gap-3 px-3 py-2 text-sm hover:bg-gray-100 rounded-md font-medium transition-colors duration-200 {{ $isActive ? 'text-green-600 bg-green-50' : '' }}">
