    ...
    <div class="flex flex-col md:flex-row gap-6 container">
        ...
        <div class="w-full md:w-1/3 lg:w-1/4 bg-sub p-6 rounded-lg shadow-sm border border-brand/10">
            <div class="space-y-6">
                ...
                <div>
                    <h3 class="text-heading-lg font-semibold text-main-text mb-2 font-jp">Location</h3>
                    <p class="text-body-md text-main-text/90">{{ $businessSettings->address ?? '2095-8 Miyadera, Iruma-shi, Saitama-ken' }}</p>
                </div>

                <div>
                    <h3 class="text-heading-lg font-semibold text-main-text mb-2 font-jp">Opening Hours</h3>
                    <ul class="text-body-md text-main-text/90 space-y-1">
                        ...
                        @else
                            <li class="flex justify-between"><span>Monday</span><span>10:00 ~ 18:00</span></li>
                            <li class="flex justify-between"><span>Tuesday</span><span>10:00 ~ 18:00</span></li>
                            <li class="flex justify-between text-main-text/40"><span>Wednesday</span><span>Closed</span></li>
                            <li class="flex justify-between text-main-text/40"><span>Thursday</span><span>Closed</span></li>
                            <li class="flex justify-between"><span>Friday</span><span>10:00 ~ 18:00</span></li>
                            <li class="flex justify-between"><span>Saturday</span><span>10:00 ~ 18:00</span></li>
                            <li class="flex justify-between"><span>Sunday</span><span>10:00 ~ 18:00</span></li>
                        @endif
                ...
                <div class="pt-4 border-t border-brand/20">
                    <a href="#" class="text-link hover:text-link-hover hover:underline transition-colors duration-300 text-body-md">About Us</a>
                    <a href="#" class="text-link hover:text-link-hover hover:underline transition-colors duration-300 block mt-2 text-body-md">Terms of Use</a>
                </div>
            </div>
        </div>

        <div class="flex-1 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <h2 class="text-title-lg font-bold font-jp text-brand mb-6">Inquiry</h2>
            ...
            <form action="{{ route('inquiry.submit') }}" method="POST" class="space-y-5">
                @csrf
                <div>
                    <label for="name" class="block text-body-md font-medium text-main-text mb-1">Name *</label>
                    <input type="text" id="name" name="name" 
                        value="{{ old('name', auth()->user()->full_name ?? '') }}" 
                ...
                <div>
                    <label for="phone" class="block text-body-md font-medium text-main-text mb-1">Phone Number</label>
                    <input type="tel" id="phone" name="phone" 
                        value="{{ old('phone', auth()->user()->phone_number ?? '') }}"
                ...
                <div>
                    <label for="subject" class="block text-body-md font-medium text-main-text mb-1">Subject *</label>
                    <input type="text" id="subject" name="subject" value="{{ old('subject') }}"
                ...
                <div>
                    <label for="message" class="block text-body-md font-medium text-main-text mb-1">Inquiry Content *</label>
                    <textarea id="message" name="message" rows="5"
